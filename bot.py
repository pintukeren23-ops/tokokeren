...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "batal":
        ...
        caption = (
            ...
            "Cara bayar:\n"
            "1. Scan QR di atas\n"
            "2. Masukkan nominal Rp " + f"{p['harga']:,}".replace(",", ".") + " secara manual\n"
            "3. Selesaikan pembayaran\n"
            "4. Screenshot bukti bayar\n"
            "5. Klik tombol di bawah & kirim foto bukti\n\n"
            "Nama toko: RVO STORE\n"
            "NMID: ID1025420578136"
        )
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("Saya Sudah Bayar - Kirim Bukti", callback_data="minta_bukti|" + str(order_id) + "|" + nomor)],
            [InlineKeyboardButton("Batal", callback_data="batal")]
        ])
